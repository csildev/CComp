...
pub fn translate_instruction(i: &gencode::Instruction) -> String {
    match i {
        gencode::Instruction::If(r1, s) => format!("cmp {}, 0\nje {}", translate_register(r1), s),
        gencode::Instruction::NIF(r1, s) => format!(
            "cmp {}, 0\njne {}",
            translate_register(r1),
            s),
        gencode::Instruction::MovSR(r1, r2) => {
            format!("mov {}, [rbp - {}]", translate_register(r2), r1)
        }
        gencode::Instruction::MovRS(r1, r2) => {
            format!("mov [rbp - {}], {}", r2, translate_register(r1),)
        }
        gencode::Instruction::MovRR(r1, r2) => {
            format!("mov {}, {}", translate_register(r1), translate_register(r2),)
        }
        ...
        gencode::Instruction::PopR(r) => format!("pop {}", translate_register(r)),
        gencode::Instruction::AddRR(r1, r2) => {
            format!("add {}, {}", translate_register(r1), translate_register(r2))
        }
        gencode::Instruction::AddRC(r1, c) => format!("add {}, {}", translate_register(r1), c),
        gencode::Instruction::SubRR(r1, r2) => {
            format!("sub {}, {}", translate_register(r1), translate_register(r2))
        }
        ...
        gencode::Instruction::BoolOr(r1, r2) => format!(
            "or {}, {}\nmov {}, 0\nsetnz {}",
            translate_register(r1),
            translate_register(r2),
            translate_register(r1),
        ...
        gencode::Instruction::BoolAnd(r1, r2) => format!(
            "cmp {}, 0\nsetne {}\ncmp {},0\nsetne {}\nand {}, {}",
            translate_register(r2),
            translate_small_register(r2),
            translate_register(r1),
